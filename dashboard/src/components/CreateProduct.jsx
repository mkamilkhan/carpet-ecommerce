...
const CreateProduct = ({ isOpen, onClose, onProductAdded, showNotification }) => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            onProductAdded();
            if (showNotification) showNotification('New product added to inventory');
        ...
        <div className="fixed inset-0 bg-black/90 backdrop-blur-xl flex items-center justify-center z-[150] p-4 lg:p-8 overflow-hidden">
            <div className="bg-[#1A1A1A] rounded-3xl w-full max-w-5xl max-h-full overflow-hidden shadow-2xl border border-white/10 flex flex-col animate-scale-in">
                ...
                <div className="p-8 border-b border-white/5 flex justify-between items-center bg-white/[0.02]">
                    <div>
                        <h2 className="text-3xl font-extrabold text-white tracking-tight italic">Catalog <span className="text-[#CB9F3B]">New Product</span></h2>
                        <p className="text-[10px] font-bold text-white/40 uppercase tracking-[0.3em] mt-2">Inventory Augmentation System</p>
                    </div>
                        ...
                        <div className="lg:col-span-7 space-y-10">
                            <div>
                                ...
                                <div className="space-y-6">
                                    <input
                                        ...
                                        placeholder="Product Name (e.g. Elegance Wool Carpet)"
                                    />
                            ...
                            <div>
                                ...
                                <textarea
                                    ...
                                    placeholder="Provide detailed information about the materials, craftsmanship, and unique features..."
                                ></textarea>
                            </div>
                            ...
                            <div className="p-8 bg-white/[0.03] rounded-3xl border border-white/5 space-y-8">
                                ...
                                {formData.type === 'Carpet' && (
                                    <div className="animate-fade-in">
                                        <label className="block text-[10px] font-black text-[#CB9F3B] uppercase tracking-[0.2em] mb-4">Chromatic selection (HEX Codes)</label>
                                        <input
                                            type="text"
                                            name="colors"
                            ...
                            <div>
                                ...
                                <div className="grid grid-cols-1 gap-6">
                                    <div className="relative aspect-video rounded-3xl border-2 border-dashed border-white/10 overflow-hidden group hover:border-[#CB9F3B]/50 transition-all cursor-pointer bg-white/[0.02]">
                                        {preview ? (
                                            <img src={preview} alt="Primary" className="w-full h-full object-cover transition-transform duration-700 group-hover:scale-110" />
                                        ) : (
                                            <div className="absolute inset-0 flex flex-col items-center justify-center gap-3">
                                                <div className="w-16 h-16 rounded-full bg-white/5 flex items-center justify-center group-hover:bg-[#CB9F3B] group-hover:text-white transition-all">
                                        ...
                                        {galleryPreviews.length > 0 ? (
                                            <div className="flex gap-2 overflow-hidden h-full py-3">
                                                {galleryPreviews.map((p, i) => (
                                                    <img key={i} src={p} className="h-full aspect-square object-cover rounded-lg border border-white/10" />
                                                ))}
                                            ...
                                            <div className="flex items-center gap-4 text-white/20 group-hover:text-[#CB9F3B] transition-colors">
                                                <FiPlus size={20} />
                                                <span className="text-[10px] font-black uppercase tracking-widest">Add Gallery Imagery</span>
                                            </div>
                                        )}
                ...
                <div className="p-8 border-t border-white/5 flex justify-end items-center gap-8 bg-white/[0.02]">
                    <button type="button" onClick={onClose} className="text-white/40 hover:text-white font-bold uppercase tracking-[0.2em] text-[10px] transition-colors">Abort</button>
                    <button 
