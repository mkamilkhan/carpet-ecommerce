...
const CategoryCards = () => {
    const cards = [
        ...
        { title: 'Vinyl', icon: <FiLayers size={36} />, link: '/collection?category=Vinyl' },
        { title: 'Laminate', icon: <FiAlignJustify size={36} />, link: '/collection?category=Laminate' },
        { title: 'Luxury Vinyl', icon: <FiGrid size={36} />, link: '/collection?category=Vinyl' },
        { title: 'Engineered Wood', icon: <FiMaximize size={36} />, link: '/collection?category=Wood' },
