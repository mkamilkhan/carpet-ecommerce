...
const CreateProduct = ({ isOpen, onClose, onProductAdded }) => {
    ...
    return (
        <div className="fixed inset-0 bg-brand-btn/80 backdrop-blur-md flex items-center justify-center z-[150] p-4">
            <div className="bg-brand-card rounded-[2.5rem] w-full max-w-3xl max-h-[90vh] overflow-hidden shadow-[0_0_100px_rgba(0,0,0,0.5)] animate-fade-in text-brand-light border border-brand-light/40 flex flex-col">
